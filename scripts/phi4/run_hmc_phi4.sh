...
usage() {
  cat <<'EOF'
Usage:
  scripts/phi4/run_hmc_phi4.sh [wrapper options] [-- hmc args...]
...
Examples:
  scripts/phi4/run_hmc_phi4.sh --workdir runs/phi4/hmc-test -- \
    --shape 16,16 --lam 2.4 --mass -0.4 --batch-size 32 --nmd 4 --tau 1.0
EOF
}
