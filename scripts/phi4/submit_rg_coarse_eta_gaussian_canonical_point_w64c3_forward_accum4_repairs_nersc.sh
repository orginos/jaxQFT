...
usage() {
  cat <<'EOF'
Usage:
  scripts/phi4/submit_rg_coarse_eta_gaussian_canonical_point_w64c3_forward_accum4_repairs_nersc.sh [options]

Submit the unresolved w64c3 forward L128 repairs as fresh replacement bundles,
using the batch32 + grad_accum_steps=4 repair card.

Optional:
  --repo-root PATH       Repo root on NERSC. Default: /global/cfs/cdirs/hadron/jaxQFT
  --bundle-root PATH     Parent bundle root. Default:
                         /global/cfs/cdirs/hadron/jaxQFT/runs/phi4/bundles/canonical-point-scan-forward/w64c3-accum4-repairs-20260418
...
bundle_root="/global/cfs/cdirs/hadron/jaxQFT/runs/phi4/bundles/canonical-point-scan-forward/w64c3-accum4-repairs-20260418"
time_a="00:55:00"
time_b="00:55:00"
qos="regular"
...
bundle_a_tasks="${repo_root}/configs/phi4/paper-2/canonical-point-scan/forward-repair-wave-20260418-accum4/w64c3_bundle_a.tsv"
bundle_b_tasks="${repo_root}/configs/phi4/paper-2/canonical-point-scan/forward-repair-wave-20260418-accum4/w64c3_bundle_b.tsv"
...
declare -a cmd_a=(
  ...
  --job-name "phi4-can-w64c3-fwd-accum4-a"
  --time "${time_a}"
  --account "${account}"
  --qos "${qos}"
)
declare -a cmd_b=(
  ...
  --job-name "phi4-can-w64c3-fwd-accum4-b"
  --time "${time_b}"
  --account "${account}"
  --qos "${qos}"
)
