...
usage() {
  cat <<'EOF'
Usage:
  scripts/phi4/submit_rg_coarse_eta_gaussian_canonical_point_w64c3_forward_accum4_warmup_canonical3_repairs_nersc.sh [options]
...
Optional:
  ...
  --bundle-root PATH     Parent bundle root. Default:
                         /global/cfs/cdirs/hadron/jaxQFT/runs/phi4/bundles/canonical-point-scan-forward/w64c3-accum4-warmup-canonical3-repairs-20260418
...
bundle_root="/global/cfs/cdirs/hadron/jaxQFT/runs/phi4/bundles/canonical-point-scan-forward/w64c3-accum4-warmup-canonical3-repairs-20260418"
time_limit="01:15:00"
qos="regular"
...
tasks_file="${repo_root}/configs/phi4/paper-2/canonical-point-scan/forward-repair-wave-20260418-accum4-warmup-canonical3/w64c3_bundle.tsv"
...
declare -a cmd=(
  ...
  --job-name "phi4-can3-w64c3-fwd-accum4-warmup"
  --time "${time_limit}"
  --account "${account}"
  --qos "${qos}"
)
